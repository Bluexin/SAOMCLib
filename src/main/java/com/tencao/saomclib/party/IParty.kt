...
abstract class IParty : IPartyData() {
     ...
     */
    fun addMember(member: PlayerEntity): Boolean = addMember(PlayerInfo(member))
     ...
     */
    fun acceptInvite(player: PlayerEntity): Boolean = acceptInvite(PlayerInfo(player))
     ...
     * @return whether the operation was successful
     */
    fun removeMember(member: PlayerEntity): Boolean = removeMember(PlayerInfo(member))
     ...
     */
    fun sync(member: PlayerEntity) = sync(PlayerInfo(member))
     ...
     */
    fun invite(player: PlayerEntity): Boolean = invite(PlayerInfo(player))
     ...
     */
    fun cancel(player: PlayerEntity): Boolean = cancel(PlayerInfo(player))
     ...
     */
    fun changeLeader(player: PlayerEntity): Boolean = changeLeader(PlayerInfo(player))
